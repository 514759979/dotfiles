    ...
    def app_default(self, c):
        ...
        if f.extension is not None:
            ...
            if f.extension in ('html', 'htm', 'xhtml') or f.extension == 'swf':
                c.flags += 'd'
                handler = self.either(c, 'o', 'chromium', 'firefox')
            ...
            if f.extension in ('html', 'htm', 'xhtml'):
                ...
                c.flags += 'D'
                return self.either(c, 'w3m', 'elinks', 'links', 'links2', 'lynx')
            if f.extension == 'nes':
            ...
            if f.extension in ('odt', 'ods', 'odp', 'odf', 'odg', 'odb', 'sxc',
                ...
                return self.either(c, 'o', 'gnumeric', 'libreoffice')
